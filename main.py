...
manager_choice = MangerChoice(manager_tool)
manager_text = MangerText()
manager_tool = ManagerTool()
manager_content = MangerContent(manager_tool)
    ...
    while choice != "11":
        ...
        match choice:
            ...
            case "5":
                ...
                elif len(tournament.round_list) == tournament.round_number:
            ...
            case "6":
                if not manager_tool.round_in_progress(tournament):
